...
# 📖 [ruby-emunarable] <a name="about-project"></a>

**[ruby-emunarable]** simple ruby project implimented using ruby emunarables.
...
```sh
  git clone https://github.com/Adholah96/ruby-emunarable.git
cd enumerable
```
...
Feel free to check the [issues page](https://github.com/Adholah96/ruby-emunarable/issues).
